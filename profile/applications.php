...
$sql = "SELECT a.*, s.status_name, s.color_code
        FROM applications a
...
<head>
    <meta charset="UTF-8">
    <title>Мои заявки - Личный кабинет</title>
    <style>
...
<header class="profile-header">
    <div class="container">
        ...
        <nav>
            ...
            <a href="applications.php" class="active">Мои заявки</a>
...
<div class="breadcrumbs">
    <div class="container">Личный кабинет / <span>Мои заявки</span></div>
</div>

<section style="padding: 20px 0 40px;">
    <div class="container">
        <h1 style="margin-bottom: 20px;">📋 Мои заявки</h1>
        ...
        <a href="../contacts.php" style="display:inline-block; margin-top:20px; background:#E67E22; color:#fff; padding:10px 25px; border-radius:5px; text-decoration:none;">➕ Новая заявка</a>
    </div>
</section>
